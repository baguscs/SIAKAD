...
@push('css')
    <style>
        .banner-area{background:url('img/hero6.jpg') no-repeat;background-size:cover}
...
<section class="banner-area relative" >
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center text-center banner-content">
            <div class="col-lg-12">
                <h1 class="text-white">Ekstrakulikuler</h1>
                <p>
                    <a class="brandcum" id="myBtn" href="{{ route('index') }}">Beranda</a> / Ekstrakulikuler 
                </p>
            </div>
        </div>
    </div>
    ...
    @foreach ($data as $item)
        <div class="col-md-6">
            <div class="containerSection">
                <div class="card">
                    <img src="{{ asset('storage/ekstra/'. $item->foto) }}" alt="Avatar" style="width:100%">
                        ...
                        <div data-modal="trigger-demo{{$loop->iteration}}" class="modal">
                            <article class="content-wrapper">
                                ...
                                <header class="modal-header">
                                    <h2>Detail Ekstrakulikuler {{$item->nama}}</h2>
                                </header>
                                <div class="content">
                                    <div class="row cardContent">
                                        <div class="col-md-5">
                                            <img class="imgModals" src="{{ asset('storage/ekstra/'. $item->foto) }}" alt="" width="180%" height="110%">
                                        </div>
