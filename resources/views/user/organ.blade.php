...
@push('css')
    <style>
        .banner-area{background:url('img/hero4.jpg') no-repeat;background-size:cover}
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center text-center banner-content">
                <div class="col-lg-12">
                    ...
                    <p>
                        <a class="brandcum" id="myBtn" href="{{ route('index') }}">Beranda</a> / Organisasi 
                    </p>
                </div>
            </div>
        </div>
        ...
        @foreach ($data as $item)
            <div class="col-md-4">
                <div class="containerSection">
                    <div class="card">
                        <img src="{{ asset('storage/pengguna/'. $item->foto) }}" alt="Avatar" style="width:100%" height="90%">
                        <div class="containerCard">
                            <h4><b>{{$item->nama}}</b></h4> 
                            <p>{{$item->struktur->jabatan}}</p>
                            <p><button data-modal-trigger="trigger-demo{{$loop->iteration}}" class=" genric-btn info circle trigger">
                                More Info
                            </button></p>
                            <div data-modal="trigger-demo{{$loop->iteration}}" class="modal">
                                ...
                                <header class="modal-header">
                                    <h2>Detail Data {{$item->nama}}</h2>
                                </header>
                                <div class="content">
                                    <div class="row cardContent">
                                        <div class="col-md-5">
                                            <img class="imgModals" src="{{ asset('storage/pengguna/'. $item->foto) }}" alt="" width="80%">
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-5">
