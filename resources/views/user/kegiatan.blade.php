...
@push('css')
    <style>
        .banner-area{background:url('img/hero8.jpg') no-repeat;background-size:cover}
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center text-center banner-content">
            <div class="col-lg-12">
                ...
                <p>
                    <a class="brandcum" id="myBtn" href="{{ route('index') }}">Beranda</a> / Kegiatan 
                </p>
            </div>
        </div>
    </div>
    ...
    @foreach ($data as $item)
        <div class="col-md-6">
            <div class="containerSection">
                <div class="card">
                    <img src="{{ asset('storage/kegiatan/'. $item->foto) }}" alt="Avatar" style="width:100%">
