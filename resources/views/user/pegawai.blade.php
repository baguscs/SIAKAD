    ...
    <section class="banner-area relative" >
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center text-center banner-content">
                <div class="col-lg-12">
                    <h1 class="text-white">Data {{$head}}</h1>
                    <p>
                        <a class="brandcum" id="myBtn" href="{{ route('index') }}">Beranda</a> / {{$head}} 
                    </p>
                </div>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>{{$item->nip}}</td>
                            <td>{{$item->tugas}}</td>
                            <td><button data-modal-trigger="trigger-demo{{$loop->iteration}}" class="btn btn-block genric-btn info circle trigger">
                                More Info
                              </button>
                                ...
                                <div data-modal="trigger-demo{{$loop->iteration}}" class="modal">
                                    <article class="content-wrapper">
                                        ...
                                        <header class="modal-header">
                                            <h2>Detail {{$item->tugas}} {{$item->nama}}</h2>
                                        </header>
                                        <div class="content">
                                            <div class="row cardContent">
                                                <div class="col-md-4">
                                                    <img class="imgModals" src="{{ asset('storage/pengguna/'. $item->foto) }}" alt="" width="90%">
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-4">
